...
<template>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-primary">
    ...
    <div class="container">
      ...
      <a class="navbar-brand me-2" href="#">
        <img src="https://mdbcdn.b-cdn.net/img/logo/mdb-transaprent-noshadows.webp" height="16" alt="Logo"
      ...
      <div class="collapse navbar-collapse" id="navbarButtonsExample">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link" href="#">DGBOOK</a>
          </li>
        </ul>
        <!-- Left links -->
        ...
        <div class="d-flex align-items-center">
          <div v-if="canLogin" class="">
            <NavLink v-if="$page.props.auth.user" :href="route('dashboard')" class="btn btn-success">Dashboard</NavLink>
            &nbsp;

            <template v-else>
              <NavLink :href="route('login')" class="btn btn-success">Se connecter
              </NavLink>
              &nbsp;&nbsp;
              <NavLink v-if="canRegister" :href="route('register')" class="btn btn-dark">S'inscrire</NavLink>
            </template>
          </div>
        </div>
      </div>
  ...
  <div class="container mt-5">
      ...
      <div class="col-8 mx-auto">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <hr>
            <div class="ml-2 mt-2 text-gray-600 text-sm">
    ...
    <div class="row">
      <div class="col-8 mx-auto">
      <div class="col-3 flex justify-center pt-8 text-center">
