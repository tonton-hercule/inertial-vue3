...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route('auteurs.destroy', id));
    }
}
</script>
    ...
    <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#" style="text-decoration: none;">Auteurs</a></li>
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                       <div class="mb-2">
                            <Link :href="route('auteurs.create')">
                                <BreezeButton>Add Auteurs</BreezeButton></Link
                            >
                        </div>
                         <div
