...
import GuestForm from "@/Layouts/GuestForm.vue";
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <NavLink :href="route('statuts.index')" style="text-decoration: none;">Statuts</NavLink>
                    </li>
                    <li class="breadcrumb-item active">Ajouter un statuts </li>
                </ol>
            </nav>
        </div>
        <GuestForm>
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form @submit.prevent="submit">
                            <div class="mb-6">
                                <InputLabel for="email" value="Libelle" />
                                <TextInput type="text" class="" v-model="form.libelle" name="libelle"
                                    required autocomplete="libelle" />
